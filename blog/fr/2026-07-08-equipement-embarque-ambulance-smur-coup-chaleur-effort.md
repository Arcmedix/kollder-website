---
title: "Coup de chaleur d'effort en ambulance SMUR : quel équipement embarquer"
date: 2026-07-08
description: "Contraintes de volume et de poids en ambulance SMUR et critères de choix d'un équipement de refroidissement embarqué pour le coup de chaleur d'effort."
...
## Pourquoi le refroidissement embarqué change la doctrine SMUR

La doctrine actuelle veut que le refroidissement définitif soit initié sur place, avant transport, et non poursuivi en roulant. Mais deux situations imposent de repenser cette règle : l'absence de moyen de refroidissement disponible sur les lieux au moment de l'arrivée du SMUR, et les interventions en zone isolée où le transport vers un point d'immersion prend plus de temps que le trajet retour vers l'hôpital.

Dans ces deux cas, disposer d'un moyen de refroidissement embarqué, capable d'être déployé rapidement au contact du patient plutôt qu'en attendant une infrastructure fixe, conditionne directement le respect de la fenêtre thérapeutique de 30 minutes établie par le consensus international (ACSM 2023).

## Les critères qui disqualifient la majorité des solutions

**Le volume plié.** Un équipement qui occupe un compartiment entier de l'ambulance n'est pas viable en dotation courante, seulement en réserve de poste médical avancé.

**Le poids et la manipulation.** Un équipement nécessitant deux opérateurs pour être sorti et déployé retarde l'intervention et mobilise un soignant qui devrait être au chevet du patient.

**La résistance à l'usage répété.** Les bacs souples ou les structures à velcro, déjà identifiés comme fragiles et sujets aux fuites dans un usage terrain intensif, ne tiennent pas la fréquence d'un véhicule d'intervention actif sur une saison estivale complète.

**L'accès patient.** Un dispositif refermé qui limite l'accès aux voies aériennes ou à la pose de voies veineuses pendant l'immersion est incompatible avec la médicalisation continue exigée en SMUR.
...
*Sources : ACSM Expert Consensus Statement 2023 ; Casa DJ et al., Exercise and Sport Sciences Reviews 2007 ; SFAR.*
