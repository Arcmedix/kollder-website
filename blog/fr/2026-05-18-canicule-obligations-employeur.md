...
- **Horaires decales obligatoires** : debut de journee avance a 6h ou interruption de l'activite pendant les heures les plus chaudes (12h-16h)
- **Recours au teletravail** encourage pour les activites compatibles
- **Amenagement d'espaces de repos climatises ou ombrages** devenant obligatoire
- **Plan canicule RH** devant etre active et communique a toutes les equipes
...
- Sanctionner le salarie
- Retenir le salaire
- Exiger la reprise du travail tant que le danger persiste
...
- Identifier les points d'eau disponibles sur chaque site
- S'assurer qu'un dispositif d'immersion peut etre deploye rapidement sur le terrain
- Former les equipes de premiers secours au protocole "cool first, transport second"

## Les secteurs les plus exposes en 2026

- **BTP et travaux publics** -- exposition directe au soleil, effort physique intense, tenues de protection contraignantes
- **Agriculture et espaces verts** -- longues expositions, faible possibilite d'abri, isolement
- **Logistique et entrepots** -- entrepots non climatises pouvant depasser 45 degres en ete, manutention intensive
- **Industrie en environnement chaud** -- fonderies, acieries, industries agroalimentaires
- **Securite et gardiennage exterieur** -- tenues reglementaires, postes fixes en plein soleil
