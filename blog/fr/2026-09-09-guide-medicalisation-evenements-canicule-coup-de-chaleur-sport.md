---
title: "Canicule et coup de chaleur sur les événements sportifs : le guide des prestataires de médicalisation"
date: 2026-09-09
description: "Guide opérationnel pour les services et entreprises de médicalisation d'événements : évaluer le risque thermique, dimensionner la chaîne de refroidissement, former les équipes et sécuriser les formats à risque comme Hyrox."
...
**La chaleur devient un risque sanitaire majeur et récurrent.** Selon [Santé publique France](https://www.santepubliquefrance.fr/climat/fortes-chaleurs-canicule/bulletin-national/chaleur-et-sante-bilan-de-lete-2025), l'été 2025 a été associé à plus de 5 700 décès attribuables à la chaleur en France, dont plus de 1 900 pendant les épisodes de canicule, avec des passages aux urgences multipliés par 2,9 pendant ces épisodes. La saison chaude s'allonge sur septembre et octobre, période où le calendrier sportif reste dense.

**Les formats à forte intensité explosent.** D'après [SportsPro](https://www.sportspro.com/features/finance-investment/hyrox-business-model-mass-participation-private-equity-investment/), Hyrox est passé d'environ 570 000 participants sur la saison 2024/2025 à près de 1,5 million sur la saison 2025/2026, le nombre de courses passant de 74 à 105. Le calendrier 2025/2026 dépasse pour la première fois [100 événements](https://barbend.com/news/hyrox-exceeds-100-calendar-events/). Ces épreuves concentrent un effort maximal sur une durée courte, en salle, souvent mal ventilée.

**Le coup de chaleur d'effort a une incidence réelle, mesurable et évitable.** Sur la Falmouth Road Race (7 miles, mois d'août), l'étude de référence de [DeMartini et al. (2015)](https://doi.org/10.1249/MSS.0000000000000409) rapporte 274 cas de coup de chaleur d'effort sur 18 ans, soit une incidence moyenne de 2,13 cas pour 1 000 arrivants, montée jusqu'à 6,57 pour 1 000 lors de l'année la plus chaude. Résultat clé pour un prestataire : avec immersion en eau froide immédiate sur site, le taux de survie a été de 100 %, et 93 % des patients sont repartis directement du poste médical. À titre de comparaison, l'arrêt cardiaque en course de fond reste rare, environ 0,54 pour 100 000 coureurs selon [Kim et al., NEJM 2012](https://www.nejm.org/doi/full/10.1056/NEJMoa1106468). Sur une épreuve chaude, le coup de chaleur d'effort est donc l'urgence vitale la plus probable, et celle sur laquelle le dispositif a le plus de prise.
...
- **Un objectif chiffré** : ramener la température centrale sous 40 °C en moins de 30 minutes après le collapsus. C'est le seuil au-delà duquel, selon le [Korey Stringer Institute](https://koreystringer.institute.uconn.edu/heat-stroke/), la survie chute et les séquelles apparaissent.

Le consensus du CIO publié dans le British Journal of Sports Medicine (Racinais, Hosokawa et al.) demande explicitement aux organisateurs de garantir la disponibilité d'un [équipement de refroidissement par immersion sur site](https://pmc.ncbi.nlm.nih.gov/articles/PMC9811094/). Un prestataire qui propose une offre sans ce volet expose l'organisateur, et se met lui-même en risque juridique en cas d'incident.
...
L'outil [EHS Monitor de Kollder](https://kollder.com/fr/monitor/) calcule le WBGT en temps réel à partir des données météo locales et situe le niveau de risque selon les seuils ACSM. Il permet de documenter la décision et d'ajuster le dispositif la veille et le jour J.
...
- **Refroidissement actif** : viser une vitesse de l'ordre de 0,15 à 0,20 °C par minute. À Falmouth, la vitesse moyenne obtenue en immersion a été de 0,22 °C par minute ([DeMartini et al., 2015](https://doi.org/10.1249/MSS.0000000000000409)).
...
- [Solution Kollder pour l'assistance médicale d'événements](https://kollder.com/fr/assistance-medicale-evenements/)
- [Poste de refroidissement pour événements sportifs : guide pour organisateurs](https://kollder.com/blog/fr/2026-06-25-poste-refroidissement-evenements-sportifs-guide/)
- [Dimensionner un poste de secours en cas de vigilance canicule : recommandations DPS](https://kollder.com/blog/fr/2026-07-09-dimensionner-poste-secours-vigilance-canicule-dps/)
- [Équipement médical obligatoire pour un trail ou marathon en période de canicule](https://kollder.com/blog/fr/2026-05-29-equipement-medical-trail-marathon-canicule/)
- [Hyrox : pourquoi une baignoire de refroidissement doit être au poste médical](https://kollder.com/blog/fr/2026-05-30-hyrox-baignoire-refroidissement-poste-medical/)
- [Hyrox de Lyon : ce que l'échec du protocole de refroidissement enseigne](https://kollder.com/blog/fr/2026-05-26-hyrox-lyon-deces-coup-chaleur-protocole-refroidissement/)
...
- [Coup de chaleur classique et coup de chaleur d'effort : la différence](https://kollder.com/blog/fr/2026-07-08-coup-de-chaleur-classique-coup-de-chaleur-effort-difference/)
