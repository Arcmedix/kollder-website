---
title: "CIO, World Athletics, ASPETAR : ce que le consensus international dit sur le coup de chaleur lors des compétitions sportives"
date: 2026-05-24
description: "Le groupe d'experts du CIO sur la chaleur, co-coordonné par le Dr Sébastien Racinais d'ASPETAR Qatar, a publié des recommandations précises pour les compétitions sportives. Ce que chaque médecin d'événement doit appliquer."
...
La [publication de Hosokawa, Racinais, Akama, Casa et al.](https://pmc.ncbi.nlm.nih.gov/articles/PMC8639927/) dans le *British Journal of Sports Medicine* (2021) définit les standards pour les fédérations affiliées au CIO.

**1. Détection précoce sur parcours**
Les commissaires, secouristes de parcours et bénévoles doivent être formés à reconnaître les signes d'alerte : confusion, désorientation, instabilité de la marche. Tout athlète qui s'effondre pendant ou après la compétition est un CCE présomptif.

**2. Température rectale comme standard diagnostique**
