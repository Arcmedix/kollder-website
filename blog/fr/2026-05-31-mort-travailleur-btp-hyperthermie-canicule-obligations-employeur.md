---
title: "Mort d'un ouvrier BTP en canicule : ce que chaque employeur doit mettre en place avant le prochain été"
date: 2026-05-31
description: "Un couvreur de 19 ans est mort d'hyperthermie dans la Drome le 27 mai 2026. Ce drame pose une question directe aux employeurs du BTP et de l'EHS : que faut-il faire concrètement pour ne pas se retrouver dans la même situation."
...
- **Vigilance jaune** : épisode de chaleur intense. Des mesures de prévention doivent être déclenchées.
- **Vigilance orange** : période de canicule. Les obligations sont renforcées. Les arrêts de travail dans le BTP deviennent indemnisables.
- **Vigilance rouge** : canicule exceptionnelle. Les mesures les plus strictes s'appliquent.

Les obligations concrètes imposées aux employeurs comprennent notamment :

- L'évaluation des risques liés à l'exposition à la chaleur, en intérieur comme en extérieur
- La mise à disposition d'eau potable fraîche en quantité suffisante (minimum 3 litres par jour par travailleur en l'absence d'eau courante sur le chantier)
- L'aménagement des horaires de travail pour éviter les heures les plus chaudes
- La formation et l'information des travailleurs sur les signes d'alerte
- La désignation d'un référent interne pour la gestion des épisodes de chaleur
...
Plus d'informations sur [kollder.com/#contact](https://kollder.com/#contact).
...
- [Immersion eau froide vs autres méthodes : comparatif](https://kollder.com/blog/fr/2026-05-25-immersion-eau-froide-vs-autres-methodes-comparatif/)
