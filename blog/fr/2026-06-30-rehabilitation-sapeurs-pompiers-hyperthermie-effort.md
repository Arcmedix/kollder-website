---
title: "Réhabilitation des sapeurs-pompiers après hyperthermie d'effort : protocoles et équipements"
date: 2026-06-30
description: "Protocoles de réhabilitation thermique pour les sapeurs-pompiers après intervention : spécificités physiologiques, refroidissement actif et équipements adaptés aux contraintes SDIS."
...
- La chaleur produite par son propre métabolisme musculaire (charge endogène)
- La chaleur rayonnée par l'environnement en feu (charge exogène)
...
- Tout comportement inhabituel chez un agent par ailleurs lucide
...
- Retrait de la tenue de protection dès que la sécurité le permet
- Mise à l'ombre ou dans un environnement frais
- Mesure de la température rectale si disponible
...
- Application de packs de glace sur les zones vasculaires (cou, aisselles, aines)
- Brumisation avec ventilation forcée si disponible
- Ingestion de boissons fraîches si le niveau de conscience le permet
- Surveillance rapprochée et réévaluation toutes les 5 minutes
...
- Température centrale stable en dessous de 38,5 °C
- État neurologique normal et stable
- Absence de signes de défaillance hémodynamique
- Réhydratation débutée et bien tolérée
...
**Contrainte 1 : le gabarit**
L'espace de stockage dans un VLTT, une VPL ou un CCF est compté. Un dispositif de refroidissement embarqué doit occuper un volume minimal en position repliée, sans empiéter sur les dotations opérationnelles.
...
- **Une procédure écrite** : qui déclenche, qui agit, quel matériel, dans quel délai
- **Une formation des chefs de groupe** à la reconnaissance des signes d'alerte et au déclenchement du protocole
- **Un équipement en dotation** sur les véhicules engagés en feux de forêt et sur les interventions longue durée en période de canicule
- **Un suivi médical post-exposition** systématique pour les agents ayant présenté des signes d'hyperthermie, même résolus sur le terrain
