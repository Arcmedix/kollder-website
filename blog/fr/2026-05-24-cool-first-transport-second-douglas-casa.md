...
Depuis, il a publié plus de 200 articles scientifiques sur le CCE et a traité personnellement des centaines de patients sans aucun décès.

## La donnée qui change tout : 100% de survie en 30 minutes
...
## Pourquoi "cool first, transport second" change l'approche
...
## L'immersion en eau froide : seule méthode suffisamment rapide
...
En 2025, le KSI avait modifié ou fait adopter plus de 466 politiques ou lois dans les états américains concernant la gestion des urgences dans le sport. Concernant le CCE spécifiquement : 15 états américains exigent désormais la présence d'une baignoire de refroidissement par immersion lors des entraînements sportifs à risque.

Casa compare le protocole à l'utilisation d'un défibrillateur : *"Cool first, transport second is just like using an AED for a cardiac event."* L'équipement doit être présent, les secouristes formés, et le protocole automatique.
