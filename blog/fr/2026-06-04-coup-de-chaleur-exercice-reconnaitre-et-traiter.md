---
title: "Coup de chaleur d'exercice : reconnaître, agir, traiter"
date: 2026-06-04
description: "Comment identifier un coup de chaleur d'exercice sur le terrain et quelles solutions permettent de traiter efficacement cette urgence vitale."
...
**Serviettes humides et poches de glace**
Taux de refroidissement : environ 0,03 °C/min. Insuffisant pour traiter un CCE constitué. Ces méthodes sont adaptées à la prévention ou au traitement des formes légères, pas à l'urgence vitale.

**Douche ou brumisation avec ventilation**
Légèrement plus efficaces, mais très dépendantes des conditions environnementales (humidité, vent). Non standardisables sur le terrain.

**Ice sheet method (draps de glace)**
