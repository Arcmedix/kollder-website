...
La baignoire de refroidissement [Kollder](https://kollder.com/#contact) est conçue pour ce protocole : avec sa structure stable à 6 points d'appui, elle permet d'initier l'immersion immédiatement sur site, quelle que soit la configuration du terrain.
