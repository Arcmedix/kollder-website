---
title: "Cooling Solutions for Exertional Heat Stroke: Which Method Works in the Field?"
date: 2026-06-04
description: "A data-driven comparison of exertional heat stroke cooling methods and a guide to choosing the right solution based on your operational context."
...
The clinical objective is non-negotiable: return core temperature below 40 °C within 30 minutes. That single target defines whether a cooling method is adequate for EHS or not. Every comparison must start from the **cooling rate** in °C per minute.
...
Water conducts heat approximately 25 times more effectively than air. Full-body immersion in cold water (10–15 °C) creates a continuous, large-surface thermal gradient that no other field-applicable method can replicate. From a starting temperature of 42 °C, CWI returns a patient to 38.5 °C in approximately 10–15 minutes.

CWI is the unambiguous gold standard endorsed by the ACSM (2023), the IOC (Hosokawa et al., BJSM 2021), and the SFAR. The Korey Stringer Institute (Dr Douglas Casa, UConn) reports 100% survival across 401 EHS cases when CWI was applied and core temperature was reduced below 40 °C within 30 minutes.

## Comparison table

| Method | Cooling rate | Field reliability | Recommended for EHS |
|---|---|---|---|
| Ice packs / wet towels | 0.03–0.10 °C/min | High | No |
| Ice sheets | 0.10–0.20 °C/min | Moderate | No |
...
The **Kollder portable cooling tub** is built around this specific operational problem. It is a reinforced PVC and aluminium-frame tub (205 × 65 × 35 cm deployed, compact when folded) that deploys in under 2 minutes by a single responder, on any terrain. It provides full patient immersion — from shoulders to feet — with complete medical access throughout: rectal thermometry monitoring, IV lines, airway management. There is no need to extract the patient during treatment.
...
- [Ice Sheet vs Cold Water Immersion: Comparative Review (FR)](https://kollder.com/blog/fr/2026-05-25-immersion-eau-froide-vs-autres-methodes-comparatif/)
