...
Kollder is designed for teams that cannot afford to wait. Stable on any terrain, with room for up to 2 people in simultaneous immersion, it allows the *Cool first, transport second* protocol to be applied without any prior infrastructure.
