...
1. **Extract to a protected position.** Move the casualty out of direct sun and away from radiant heat sources.

2. **Remove kit.** Helmet, body armor, and uniform — remove everything that can be removed. Maximize exposed skin surface.

3. **Measure rectal temperature.** Do not delay cooling if a thermometer is unavailable, but measure as soon as possible to guide treatment endpoints.

4. **Immerse in cold water.** Full-body cold water immersion is the gold standard. Use the coldest water available — from vehicle water supplies, local sources, or ice stocks.

5. **Monitor.** Rectal temperature every 5 minutes. Continue cooling until core temperature reaches 102 degrees Fahrenheit. Do not stop earlier.

6. **Initiate MEDEVAC.** Call in simultaneously with cooling, not after. If MEDEVAC is delayed, continue cooling at the point of injury.

7. **Transmit a thorough handoff.** Include time of symptom onset, cooling start time, temperature trend, and any other treatments administered.
...
1. **Neurological signs after exertion in heat = presumptive EHS.** Treat immediately.
2. **Cool before you move.** Every minute matters.
3. **Rectal temperature is the only reliable measurement.** Train your unit to accept this.
4. **Stop cooling at 102 degrees Fahrenheit** — not at clinical improvement, not at arrival of higher-level care.
5. **Transport every case to a medical facility**, even after apparent recovery. Lab work is essential.
6. **Document the cooling timeline.** Time of onset, time cooling started, temperature at cooling endpoint — this information directly affects downstream care.
