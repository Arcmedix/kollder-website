---
title: "Cool First, Transport Second: el protocolo que salva vidas en el golpe de calor por esfuerzo"
date: 2026-09-19
description: "Cool First, Transport Second es el estándar prehospitalario reconocido internacionalmente para el golpe de calor por esfuerzo. Origen, base científica, aplicación en el terreno y equipo necesario."
...
howToSchema: |
  {
    ...
    "@type": "HowTo",
    "name": "Aplicación práctica del protocolo",
    "step": [
      {
        "@type": "HowToStep",
        "name": "Reconocimiento (0-2 minutos)",
        "text": "Cualquier colapso durante o inmediatamente después de un esfuerzo físico intenso con temperatura corporal central de 40 °C o superior (timpánica o rectal) y signos neurológicos (confusión, agitación, pérdida de conciencia, convulsiones): sospecha de golpe de calor por esfuerzo, se activa de inmediato el protocolo Cool First."
      },
      {
        "@type": "HowToStep",
        "name": "Enfriamiento (2-20 minutos)",
        "text": "Desplegar la bañera de inmersión, llenarla con agua fría y hielo, sumergir por completo al paciente (hombros y cuero cabelludo), mantener la vía aérea por encima del agua. Monitorización continua de la temperatura rectal cada 5 minutos."
      },
      {
        "@type": "HowToStep",
        "name": "Avisar a emergencias (en paralelo)",
        "text": "La llamada a los servicios de emergencia se realiza en paralelo al enfriamiento, no antes. El mensaje debe indicar: 'Golpe de calor por esfuerzo en tratamiento mediante inmersión en agua fría, se solicita traslado a urgencias cuando la temperatura baje de 38,6 °C.'"
      },
      {
        "@type": "HowToStep",
        "name": "Detener el enfriamiento y trasladar",
        "text": "Retirar al paciente de la bañera al alcanzar 38,6 °C de temperatura rectal. No esperar a los 37 °C, riesgo de hipotermia por inercia térmica. Trasladar a urgencias para análisis (CPK, función renal, coagulación) y vigilancia de complicaciones secundarias."
      }
    ]
  }
---
